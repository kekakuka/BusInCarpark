...
function App({ reports, loading, setLoading, error, clearError }) {
  ...
  return (
    <Container>
      <div>
        ...
        <br />
        <Report reportInfo={reportInfo} disabled={loading} />
      </div>
      ...
      <TaskSheet
        ...
        loading={loading}
      />
      <SavedReport reportInfo={reports} disabled={loading} />
    </Container>
  );
}
const mapSetLoadingToProps = { setLoading: action.reports.setLoading, clearError: action.reports.getError };
export default connect(state => state.reports, mapSetLoadingToProps)(App);
